...
from controllers.principio_controller import PrincipioController
...
class PrincipioView:
    ...
    def __init__(self, root, db):
        ...
        self.controller = PrincipioController(db)
        ...
        fields = ['codigo','nombre_cientifico','formula','origen','precauciones','id_proveedor']
        self.entries = {}
        ...
        for i, field in enumerate(fields):
            ...
            if field == "origen":
                entry = ttk.Combobox(left_frame, values=["NATURAL","SINTETICO","SEMISINTETICO"], state="readonly", width=30)
            else:
